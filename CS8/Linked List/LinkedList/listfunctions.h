...
//template<typename T>node<T>* Previous(node<T> *location, node<T>& head);
//template<typename T> void Insert(T i,node<T> &head);
//template<typename T> void InsertBefore(node<T>* location,T i, node<T> &head);
//template<typename T> void insertAfter(node<T>* location, T i);
//template<typename T> node<T>* gethead(node<T>* head);
//template<typename T> node<T>* insertSorted(T i,node<T>* head);
//template<typename T> node<T>* Search(T i,node<T>* head);
//template<typename T> node<T>* At(int i,node<T>* head);
//template<typename T> void Delete(node<T>* deletethis,node<T>* head);
//template<typename T> void Print(node<T>* head);
//template<typename T> int count(node<T>* head);
//template<typename T> void Reverse(node<T>* head);
//template<typename T> void DeleteRepeats(node<T>* head);
//template<typename T> void sort(node<T>* head);
//template<typename T> node<T>* Remove(node<T>*removethis, node<T>* head);
//template<typename T> void copy(node<T> *head1, node<T> *copythis);
//template<typename T> void Shuffle(node<T>* head);
//template<typename T> void Merge(node<T>* thehead);
