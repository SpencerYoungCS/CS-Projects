...
struct qt_meta_stringdata_MyGui_t {
    QByteArrayData data[8];
    char stringdata[47];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_MyGui_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_MyGui_t qt_meta_stringdata_MyGui = {
    {
...
QT_MOC_LITERAL(7, 39, 6)
    ...
    "MyGui\0actionSignal\0\0Run\0Stop\0Load\0"
    "Save\0Action\0"
};
...
void MyGui::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MyGui::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGui::actionSignal)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject MyGui::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MyGui.data,
      qt_meta_data_MyGui,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyGui.stringdata))
